g_Settings = {
    ...
    heliUSCameraOffsetZ = -3.5,

    heliRUCameraOffsetX = -3.9,
    heliRUCameraOffsetY = 1.6,
    heliRUCameraOffsetZ = -3.5,

    scoutheliUSCameraOffsetX = -2.0,
    scoutheliUSCameraOffsetY = 1.0,
    scoutheliUSCameraOffsetZ = -3.5,

    scoutheliRUCameraOffsetX = -2.0,
    scoutheliRUCameraOffsetY = 1.0,
    scoutheliRUCameraOffsetZ = -3.5,

    jetUSCameraOffsetX = 0,
    jetUSCameraOffsetY = 0,
    jetUSCameraOffsetZ = -1.2,
